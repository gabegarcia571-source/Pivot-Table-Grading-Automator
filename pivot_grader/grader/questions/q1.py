...
from grader.pivot_checker import compare_pivot_values, is_desc_sorted_within_groups
...
def grade_question(
	...
	if question_cfg.get("sort_required") and not is_desc_sorted_within_groups(student_df):
		structural_score = 0.0
